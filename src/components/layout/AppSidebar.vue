...
const navItems = [
  ...
  { name: 'Preparation',       path: '/app/preparation',   icon: BookOpen, exclude: '/app/preparation/syllabus' },
  ...
  { name: 'Competition Tests', path: '/app/competition',   icon: Trophy,  exclude: '/app/competition/leaderboard' },
